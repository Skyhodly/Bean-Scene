 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".coffee-menu__slider")) new swiper_core_Swiper(".coffee-menu__slider", {
            ...
            if (document.querySelector(".feedback__slider")) new swiper_core_Swiper(".feedback__slider", {
                ...
                navigation: {
                    prevEl: ".feedback__swiper-prev-arrow",
                    nextEl: ".feedback__swiper-next-arrow"
                },
                on: {}
            });
        }
        ...
        function fallbackCopyTextToClipboard(text) {
            ...
            try {
                ...
                copyAlert.classList.add("_active");
                setTimeout((() => {
                    copyAlert.classList.remove("_active");
                    setTimeout((() => {
                ...
                copyAlert.textContent = "Text was not copied!";
                copyAlert.classList.add("_active");
                setTimeout((() => {
                    copyAlert.classList.remove("_active");
                    setTimeout((() => {
        ...
        if (contactsInfo) contactsInfo.addEventListener("click", (el => {
            const targetParagraph = el.target;
            if (targetParagraph.closest("p")) {
                const paragraphContent = targetParagraph.textContent;
                if (!navigator.clipboard) fallbackCopyTextToClipboard(paragraphContent); else {
                    if (isAlertActive) return;
                    isAlertActive = true;
                    navigator.clipboard.writeText(paragraphContent).then((() => {
                        copyAlert.textContent = "Text copied!";
                        copyAlert.classList.add("_active");
                        setTimeout((() => {
                            copyAlert.classList.remove("_active");
        ...
        function correctingThreshold() {
            let width = window.innerWidth;
            let menu = document.querySelector(".coffee-menu");
            let about = document.querySelector(".about");
            let footer = document.querySelector(".footer");
            if (width <= 991.98 && width > 767.98) {
                menu.setAttribute("data-watch-threshold", "0.45");
                about.setAttribute("data-watch-threshold", "0.45");
                footer.setAttribute("data-watch-threshold", "0.4");
            } else if (width <= 767.98 && width > 479.98) {
                menu.setAttribute("data-watch-threshold", "0.35");
                about.setAttribute("data-watch-threshold", "0.45");
                footer.setAttribute("data-watch-threshold", "0.3");
            } else if (width <= 479.98 && width > 50) {
                menu.setAttribute("data-watch-threshold", "0.5");
                about.setAttribute("data-watch-threshold", "0.25");
                footer.setAttribute("data-watch-threshold", "0.15");
            } else {
                menu.setAttribute("data-watch-threshold", "0.8");
                about.setAttribute("data-watch-threshold", "0.8");
                footer.setAttribute("data-watch-threshold", "0.4");
            }
            flsModules.watcher.scrollWatcherUpdate();
        }
        window.addEventListener("load", correctingThreshold);
        window.addEventListener("resize", correctingThreshold);
        window["FLS"] = false;
        isWebp();
        addLoadedClass();
        menuInit();
